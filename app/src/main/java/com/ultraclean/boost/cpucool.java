...
public class cpucool extends Fragment {
    ...
    float temp;
    List<com.ultraclean.boost.apps> apps2;

    ImageView coolbutton, tempimg;

    RecyclerView recyclerView;
    public static List<com.ultraclean.boost.apps> apps;
                ...
                if (temp >= 30.0) {
                    ...
                    coolbutton.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            Intent i = new Intent(getActivity(), cpuscan.class);
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.asd_cool_c, container, false);
...
//                Log.e("Size-->", "" + packageName);
                    ...
                    try {
                        ...
                        com.ultraclean.boost.apps app = new apps();
