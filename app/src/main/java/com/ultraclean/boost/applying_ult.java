...
public class applying_ult extends Activity {
...
//                ramperct.setText(ran3.nextInt(40) + 20+"%");
                ...
                check=1;
                youDesirePermissionCode(applying_ult.this);
...
//            Toast.makeText(getApplicationContext(),"onActivityResult",Toast.LENGTH_LONG).show();
            //do your code
            power_saving_compl.setAutoOrientationEnabled(getApplicationContext(), false);
            ...
            Intent i=new Intent(applying_ult.this,battery_sav_black.class);
            startActivity(i);
            finish();
        }
    }
