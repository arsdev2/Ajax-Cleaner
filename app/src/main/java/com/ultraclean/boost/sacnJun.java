...
public class sacnJun extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.scan_jj);
        ...
        rerev.addItemDecoration(new SimpleDividerItemDecoration(this));
//                RecyclerView rerev = (RecyclerView) findViewById(R.id.list);
...
//                front.setImageDrawable(ContextCompat.getDrawable(sacnJun.this, R.drawable.task_complete));
//                imageView.setImageDrawable(ContextCompat.getDrawable(sacnJun.this, R.drawable.green_circle));
...
//        }, 1000);
    ...
    public void add(String text, int position) {
        ...
        com.ultraclean.boost.apps item=new apps();
...
//        mDataSet.add(position, text);
    ...
    public void remove(int position) {
        masdar.notifyItemRemoved(position);
